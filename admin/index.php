...
if(!isset($_SESSION['id'])){
  ...
  <center>
        ...
        <br><br>
				<div class="form-group">
					<button class="btn btn-submit" name="logear" type="submit"><i class="fa fa-sign-in"></i>Ingresar</button>
				</div>
			</div>
		</form>
	</center>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>AY</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>AY</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="avatars/Logo.png" style="width:50px;height:50px;" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="avatars/Logo.png" style="width:30px;height:30px;" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=admin_name_connected()?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="avatars/Logo.png"  class="img-circle" alt="User Image">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="avatars/Logo.png" style="width:50px;height:50px;" alt="user image" class="offline">
